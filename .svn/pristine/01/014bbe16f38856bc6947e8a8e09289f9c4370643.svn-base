...
public class SentForExecutionService {
	...
	private static Logger logger = Logger
			.getLogger(SentForExecutionService.class);
	@Autowired
	...
	public boolean sentForExecution(List<Long> blockOrder) {
		 ...
		 * "applicationContext.xml"); ActiveMQDestination destination =
		 * (ActiveMQDestination) appContext .getBean("buyDestination");
		 */
		// Destination destination = (Destination)
		// appContext.getBean("buyDestination");
