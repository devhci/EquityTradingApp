...
@Results({
		@Result(name = "send", location = "SendForExecutionPM", type = "chain"),
...
public class GetOrderIdAction extends ActionSupport {
	...
	public String execute() {
		...
		else if (option.equals(StringLiterals.EDITORDER))
			return StringLiterals.EDIT;
		else if (option.equals(StringLiterals.AMENDORDER))
			return StringLiterals.AMEND;
		else if (option.equals(StringLiterals.SENDORDER))
			return StringLiterals.SENDACTION;
